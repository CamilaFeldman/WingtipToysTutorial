...
public class NVPAPICaller
{
    ...
    public string APIUsername = "<sb-opfie6325491_api1.business.example.com>";
    private string APIPassword = "<6Q92P55V26NJ4W9N>";
    private string APISignature = "<Ae4fHI1yoAGg.VY6dmhnWmixPLMfAqjh3srVK3yMKMxuGKzZlOexE9SM>";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44310/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44310/Checkout/CheckoutCancel.aspx";
